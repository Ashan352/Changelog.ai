    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[400px] flex-col justify-center space-y-8 sm:w-[350px] p-6 rounded-2xl bg-bg-surface border border-border mt-12 sm:mt-0">
        <div className="flex flex-col space-y-2 text-center">
          ...
          <h1 className="font-serif italic text-4xl tracking-tight text-text-primary animate-fade-up" style={{ animationDelay: '0.2s' }}>
            Create an account
          </h1>
          <p className="font-mono text-sm text-text-secondary animate-fade-up" style={{ animationDelay: '0.3s' }}>
            Sign up to start generating premium changelogs.
          </p>
        </div>
        ...
        <p className="px-8 text-center font-mono text-xs text-text-muted animate-fade-in" style={{ animationDelay: '0.5s' }}>
