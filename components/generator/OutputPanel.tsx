    ...
    return (
      <div className="flex flex-col items-center justify-center h-full border border-dashed border-border rounded-2xl bg-bg-surface/50 text-text-muted space-y-4">
        ...
        <div className="pt-2 flex flex-col items-center gap-4">
           <div className="h-px w-24 bg-border/50 relative">
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-bg px-2 text-[10px] uppercase tracking-widest opacity-30">or</span>
           </div>
           
           <Link 
             href="/dashboard/import"
             className="flex items-center gap-2.5 px-6 h-11 rounded-xl bg-bg border border-border hover:border-accent/40 hover:bg-bg-elevated/50 text-text-primary font-mono text-sm transition-all active:scale-[0.98] group shadow-sm hover:shadow-md"
           >
              <svg className="h-4 w-4 transition-colors group-hover:text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />
                <path d="M9 18c-4.51 2-5-2-7-2" />
              </svg>
