...
export function GallerySection() {
  return (
    <section className="relative h-[600px] sm:h-[800px] border-y border-border overflow-hidden bg-bg-surface/30">
      ...
      >
         <div className="font-mono text-[10px] text-accent font-bold uppercase tracking-widest mb-3">Global Reviews</div>
         <h2 className="text-3xl sm:text-5xl font-serif italic text-text-primary">What they're shipping</h2>
      </div>
      
      <div aria-label="Interactive developer review gallery" role="region">
        <DomeGallery 
          fit={0.65} 
