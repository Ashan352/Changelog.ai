...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: 100%; height: 100%; background: #0a0a0a; border-left: 1px solid rgba(255,255,255,0.06); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
@media (min-width: 640px) { .sm-scope .staggered-menu-panel { width: clamp(320px, 45vw, 600px); padding: 6rem 2.5rem 2.5rem; } }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; border-right: 1px solid rgba(255,255,255,0.06); border-left: none; }
